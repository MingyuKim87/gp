...
class Attention(nn.Module):
    ...
    def __init__(self, device, embedding_type, layer_sizes, dim, att_type, scale=1., normalize=True, **kargs):
        ...
        elif self._att_type == "soft_attention":
            # prior type : contextual or else
            self.prior_type = kargs.get("prior_type", "contextual")
            # variational type : weibull or log_normal
            self.variation_type = kargs.get("variation_type", "log_normal")
    ...
    def forward(self, x1, x2, v):
        ...
        if self._att_type == 'uniform':
            ...
            representation = self.soft_attention(q, k, v, self._scale, self._normalize, \
                self.prior_type, self.variation_type)
        else:
    ...
    def soft_attention(self, q, k, v, scale, normalize, prior_type="contextual", variation_type="weibull"):
        '''
            Bayesian attention. Implemented by Tensorflow Tutorials.
        ...
        if prior_type == "contextual":
            ...
            elif variation_type == "log_normal":
        ...
        if variation_type == "weibull":
            ...
            # Parameters
            sigma_normal_posterior = 1.0
            sigma_normal_prior = 1.0
            training = 1.0
